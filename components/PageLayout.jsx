...
export default function PageLayout({
  ...
  // Безопасное canonical — корректно работает при SSR
  const fullCanonical =
    canonical ||
  ...
  return (
    <>
      <Head>
        ...
        {heroImage && <meta property="og:image" content={`${SITE}${heroImage}`} />}
      ...
      <header className="leading-normal tracking-normal text-white">
        <section className="gradient pt-24 relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="w-full md:w-2/5">
                ...
                <div className="mt-6 relative z-20">
                 <Breadcrumbs items={breadcrumb} title={title} />
                </div>
              </div>
                ...
                <div className="hidden md:block md:w-3/5">
                  <div className="flex justify-end items-center">
                    <img
                      src={heroImage}
                      alt={title}
                      className="max-h-40 md:max-h-56 lg:max-h-72 object-contain drop-shadow-lg"
                    />
                  </div>
                </div>
              )}
