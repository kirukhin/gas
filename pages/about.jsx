  ...
  return (
    <>
      ...
      <section className="gradient pt-24">
        <div className="container mx-auto px-4">
          <div className="flex items-center">
            ...
            <div className="w-full md:w-2/5">
              ...
              {/* Хлебные крошки — добавлен relative + высокий z-index чтобы быть поверх SVG */}
        ...
        {/* IMPORTANT:
            убираем отрицательный отступ на мобильных — применяем только на md и выше.
            Также делаем сам SVG неперехватывающим события (pointer-events-none),
            чтобы ссылки работали даже если волна визуально поверх. */}
        <div className="relative md:-mt-12 lg:-mt-24">
          <svg
